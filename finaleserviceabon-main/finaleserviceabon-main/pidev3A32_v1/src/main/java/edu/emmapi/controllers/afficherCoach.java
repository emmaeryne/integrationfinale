...
public class afficherCoach {
    ...
    private void loadCoachs() {
        ...
        List<Coach> users = userService.getAllDataCoach() ;// Récupérer les données à jour
        System.out.println("Nombre de coachs récupérés : " + users.size());
    ...
    private class UserCard extends VBox {
        ...
        private void handleDelete(user user) {
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                ...
                Platform.runLater(() -> loadCoachs()); // Recharger la liste des utilisateurs dans le thread JavaFX
            }
        }
    }
}
