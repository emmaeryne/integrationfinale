...
public class HomePageController {
    ...
    private void openCoursDashboard(ActionEvent event) {
        openDashboard("/coursesCards.fxml", "Cours Dashboard");
    }



    @FXML
    private void openReservationDashboard(ActionEvent event) {
        openDashboard("/admin_reservations.fxml", "Reservation Dashboard");
    }


    @FXML
    private void openReservationClientDashboard(ActionEvent event) {
        openDashboard("/reservation.fxml", "Reservation Dashboard");
    }
    @FXML
    ...
    public void openadresseDashboard(ActionEvent actionEvent) {
        openDashboard("/account_adress.fxml", "Adresse" );
